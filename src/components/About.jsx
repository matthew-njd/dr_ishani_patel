    ...
    <div className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        <img
          src={aboutPic}
          alt="about"
          className="w-[100%] relative z-[5] box-shadow-full rounded-lg"
        />
      </div>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} w-full mt-5`}>
          ...
          surprises, whether they were good or bad, and my body was constantly
          adapting to these to the best of its ability. However, nothing helped;
          it wasn’t until I started to nourish my body and establish the key
        ...
        <p className={`${styles.paragraph} w-full mt-5`}>
          ...
          state of sustainable health and wellness. I utilize a combination of
