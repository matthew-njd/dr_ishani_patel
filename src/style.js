const styles = {
  ...
  heading2:
    "font-regular font-semibold underline mb-5 xs:text-[48px] text-[40px] text-white xs:leading-[76.8px] leading-[66.8px]",
  heading4:
    "font-regluar font-semibold text-white text-[28px] leading-[23px] xs:leading-[76.8px]",
  paragraph: "font-regular font-normal text-[18px] leading-[27px]",
